...
#  Conclusiones:
#
#	El codigo se puede ver como implementa openMP dentro del metodo multiMatrix, que es llamado en el main mandando las 2 matrices previamente inicializadas, la matriz donde
#	se almacenara el resultado y el tamano de matriz. Se comprobo que el uso de openMP reduce significativamente el tiempo de ejecucion frente a una versión secuencial,
...
#	la multiplicación de matrices, el uso de paralelismo con OpenMP es una herramienta eficiente que mejora el rendimiento aprovechando la potencia del procesamiento disponible.
#****************************************************************/
